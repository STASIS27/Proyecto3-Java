...
//Objetos
	...
	public VentanaMenuMonitores() {
		...
		lblNewLabel_2_1_1.setIcon(
				new ImageIcon(VentanaMenuMonitores.class.getResource("/Imagenes/fitness-7071849_1920 (1).png")));
		lblNewLabel_2_1_1.setForeground(Color.LIGHT_GRAY);
		lblNewLabel_2_1_1.setBounds(10, -13, 35, 57);
		panel_1.add(lblNewLabel_2_1_1);

		JLabel lblNewLabel_2_2 = new JLabel("New label");
		lblNewLabel_2_2.setIcon(
				new ImageIcon(VentanaMenuMonitores.class.getResource("/Imagenes/fitness-7071849_1920 (1)2.png")));
		...
		gl_panel_2.setHorizontalGroup(gl_panel_2.createParallelGroup(Alignment.LEADING).addGroup(gl_panel_2
				...
				.addGroup(gl_panel_2.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panel_2.createSequentialGroup().addGap(10).addComponent(lblNewLabel_5,
		...
		lblImagen.setIcon(
				new ImageIcon(VentanaMenuMonitores.class.getResource("/Imagenes/sports-1975689_1920 (1).png")));
		...
		gl_panel_2_3.setHorizontalGroup(gl_panel_2_3.createParallelGroup(Alignment.LEADING).addGroup(gl_panel_2_3
				.createSequentialGroup().addContainerGap()
				.addGroup(gl_panel_2_3.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_panel_2_3.createSequentialGroup().addGap(10).addComponent(lblAquPodrasVer,
				...
				.addGroup(gl_panel_2_3.createSequentialGroup().addContainerGap()
						.addComponent(btnVerClases, GroupLayout.PREFERRED_SIZE, 108, GroupLayout.PREFERRED_SIZE)
						.addContainerGap(31, Short.MAX_VALUE)));
		gl_panel_2_3.setVerticalGroup(gl_panel_2_3.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel_2_3.createSequentialGroup().addGap(5).addComponent(btnVerClases)
						.addPreferredGap(ComponentPlacement.UNRELATED).addComponent(lblAquPodrasVer)
						.addPreferredGap(ComponentPlacement.RELATED).addComponent(lblClasessusHorarios)
						.addPreferredGap(ComponentPlacement.RELATED).addComponent(lblNewLabel_7_1).addGap(4)));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource().equals(btnAñadirClase)) {
			if (hayMonitores()) {
				...
				JOptionPane.showMessageDialog(this, "No hay monitores registrados en la base de datos.", "Advertencia",
	...
	// Metodo donde compruebo si hay monitores para las opciones de añadir o
	// eliminar clase
